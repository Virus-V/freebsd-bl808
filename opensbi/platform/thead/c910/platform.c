...
static int c910_uart_getc(void)
{

  if (!(readl((void *)(BFLB_CONSOLE_BASE + UART_FIFO_CONFIG_1_OFFSET)) &
      UART_RX_FIFO_CNT_MSK))
  {
    return -1;
  }

  return readl((void *)(BFLB_CONSOLE_BASE + UART_FIFO_RDATA_OFFSET));
}
